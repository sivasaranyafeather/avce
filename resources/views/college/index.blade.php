                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-stripped" id="totalcollege-table">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
...
<div class="modal fade" id="college_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.showcollege', function() {
    console.log("clicked");
    var id = $(this).data('id');
    console.log(id);
    var url = `/edit_college/${id}`;
    ...
    $.get(url, function(data) {
        ...
        var myModal = new bootstrap.Modal(document.getElementById('college_model'), {
            keyboard: false
        });
        myModal.show();
    })
...
// Delete Section
    $(document).on('click', '.deletecollege', function() {
      var id = $(this).data("id");
      var confirmation = confirm("Are You sure want to delete this College Details!");
      if (confirmation) {
        var editCategoryUrl = "{{ url('delete_college') }}/" + id;
